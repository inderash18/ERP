...
export default function Layout() {
  ...
  const navSections = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          path: "/layout/sales",
          icon: ShoppingCart,
          count: metrics?.pendingDeliveries > 0 ? `${metrics.pendingDeliveries}` : null,
          perm: 'sales.view'
        },
        {
        ...
        },
        {
          ...
          icon: Warehouse,
          count: metrics?.lowStockCount > 0 ? `${metrics.lowStockCount}` : null,
      ...
      items: [
        {
          ...
          icon: FileText,
          count: metrics?.pendingReceipts > 0 ? `${metrics.pendingReceipts}` : null,
          perm: 'purchase.view'
        },
        {
          name: "Shop Floor (MOs)",
          ...
          icon: Factory,
          count: metrics?.activeManufacturing > 0 ? `${metrics.activeManufacturing}` : null,
          perm: 'manufacturing.view'
        },
        {
          name: "Vendor Directory",
          path: "/layout/suppliers",
          icon: Truck,
          count: null,
          perm: 'suppliers.view'
        },
  ...
  const getBreadcrumbTitle = () => {
    ...
    if (path.includes("/purchase"))
      return "Procurement & POs";

    if (path.includes("/production"))
      return "Shop Floor (MOs)";
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* CLICKABLE ELVARA FURNITURE BRAND */}
          <div
